...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            mother_pass = pass_probability(
                gene_count(mother, one_gene, two_genes)
            )
            father_pass = pass_probability(
                gene_count(father, one_gene, two_genes)
            )
...
def gene_count(person, one_gene, two_genes):
    """
    Return the number of copies of the gene assigned to `person`.
    """
...
def pass_probability(genes):
    """
    Return the probability that a parent passes the gene to a child.
    """
    if genes == 2:
